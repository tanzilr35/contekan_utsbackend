...
<head>
    ...
    <title><?= $title; ?> | Distributor Buah & Sayur</title>
...
<body id="page-top">
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Aplikasi Pengadaan Barang 2021 &bull; by Zulfi dan Tanzil </span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script type="text/javascript">
        ...
        $(document).on('change', '#barang_id', function() {
            let url = '<?= base_url('barang/getstok/'); ?>' + this.value; // klo udh klik tombol akan masuk ke controllers/Barang.php
            $.getJSON(url, function(data) { // untuk mengambil data dari getstok
    ...
    <?php if ($this->uri->segment(1) == 'dashboard') : ?>
        ...
        <script type="text/javascript">
            ...
            // Area Chart Example
            var ctx = document.getElementById("myAreaChart"); // ngambil dari <canvas id="myAreaChart" di views/dasboard
            var myLineChart = new Chart(ctx, { //ctx = context
                type: 'line',
                data: {
